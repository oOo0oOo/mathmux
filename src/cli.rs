...
const WORKFLOW_HELP: &str = r#"AGENT CONTRACT
  api       search-v12/probe-v19; reread search/probe help only when this digest changes.
...
API probe-v19 — bounded exact inspection; reread only when this digest changes
...
mod tests {
    ...
    fn search_and_probe_help_expose_only_the_new_api() {
        ...
        let probe_help = command
            ...
            .render_long_help()
            .to_string();
        assert!(probe_help.contains("API probe-v19"));
        for contract in [
    ...
    fn workflow_help_prefers_direct_workspace_experimentation() {
        ...
        assert!(help.contains("search-v12/probe-v19"));
